...
const checkIsWinnner = () =>{
  ...
  && itemArray[3]!="empty" && itemArray[7]!="empty"&& itemArray[8]!="empty")
  {
         ...
         <Col md={6} className="offset-md-3">
           {WinMessage ? (<div className='mb-2 mt-2'>
             ...
             <h1 className='text-center' style={{color:"white"}}>
               {
                 isCross ? "Cross's":"Circle's"
               } turn
             </h1>
           )}
                 <div className="grid">
            {itemArray.map((item, index) => (
              <Card style={{backgroundColor:"red"}} onClick={() => changeItem(index)}>
